...
SECRET_KEY = os.environ.get("SECRET_KEY", "django-insecure-l=a)1403ji*xs9_t%%m@(5c&5(#lp&opn63u)%(s@%nef+#6f+")
...
ALLOWED_HOSTS = ['bookstore-c8hf.onrender.com', 'localhost', '127.0.0.1']
